...
**Entry/Target/Stop Loss** tidak lagi persentase flat dari harga close (dulu: entry selalu = harga close, target/stop = +-X% tetap). Sekarang tiap saham punya level sendiri berdasarkan struktur teknikal riilnya: entry di-anchor ke support/resistance yang sudah dipakai strategi itu sendiri (Scalping -> EMA9, Swing -> SMA20, Investment -> SMA50), dibatasi jarak realistisnya oleh ATR(14) saham itu sendiri (dihitung dari OHLC riil, metode Wilder) supaya tidak pernah mengusulkan entry di level yang terlalu jauh untuk realistis ter-fill, dan entry Buy tidak pernah di atas harga close hari ini. Stop loss dihitung dari jarak ATR yang sama, lalu digeser sedikit melewati support/resistance riil terdekat (20D untuk Scalping, 50D untuk Swing, 52W untuk Investment) kalau level itu lebih dekat dari stop berbasis ATR - supaya noise wajar di level itu tidak memicu stop sebelum level itu sendiri benar-benar diuji. Target = entry +- rasio reward:risk (1.5x untuk Scalping, 2x Swing, 2.5x Investment) dari jarak risk yang sama. Setiap kartu saham juga menampilkan **Harga Terakhir (Close)** terpisah dari Entry, supaya selalu jelas bedanya harga pasar riil sekarang vs level entry yang direkomendasikan.
