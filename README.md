...
**Entry/Target/Stop Loss** tidak lagi persentase flat dari harga close, dan entry sekarang berupa **rentang harga (zona akumulasi)**, bukan satu angka tunggal - hanya untuk verdict Buy/Strong Buy. Zona entry-nya dari support riil yang sudah dipakai strategi itu sendiri (Scalping -> EMA9, Swing -> SMA20, Investment -> SMA50) sampai harga close hari ini, dibatasi lebarnya oleh ATR(14) saham itu sendiri (dihitung dari OHLC riil, metode Wilder) supaya tidak pernah mengusulkan entry di level yang terlalu jauh untuk realistis ter-fill; kalau tidak ada support yang relevan di dekat harga, zona-nya jadi rentang sempit tepat di bawah close (beli kekuatan yang sudah terkonfirmasi, bukan menunggu pullback yang tidak ada). Stop loss di-set di bawah **seluruh zona** (melindungi entry manapun di dalam rentang itu) sejauh jarak ATR yang sama, lalu digeser sedikit melewati support/resistance riil terdekat (20D untuk Scalping, 50D untuk Swing, 52W untuk Investment) kalau level itu lebih dekat dari stop berbasis ATR. Target dihitung secara konservatif dari sisi atas zona entry (skenario entry ter-buruk) dengan rasio reward:risk (1.5x untuk Scalping, 2x Swing, 2.5x Investment). Untuk verdict **Sell/Strong Sell dan Hold, tidak ada entry** - hanya Target dan Stop Loss (Sell = aksi sekarang di harga close riil, Hold = bukan taruhan arah), keduanya tetap dihitung dari ATR riil saham itu, bukan persentase tetap. Setiap kartu saham juga menampilkan **Harga Terakhir (Close)** terpisah, supaya selalu jelas bedanya harga pasar riil sekarang vs zona entry yang direkomendasikan.
