...
SEMUA ANGKA DI BAWAH INI SUDAH DIHITUNG DARI DATA REAL - jangan mengarang angka baru, jangan mengubah verdict/entry_low/entry_high/target/stop_loss/fundamental yang sudah diberikan. Tugasmu HANYA menulis teks (catalyst per saham, ringkasan regime pasar, briefing harian) berdasarkan angka yang ada.
...
DAFTAR SAHAM KANDIDAT (verdict, entry_low/entry_high/target/stop_loss, indikator teknikal, dan fundamental SUDAH FINAL - jangan diubah; entry_low/entry_high hanya ada untuk verdict Buy/Strong Buy - itu adalah RENTANG harga akumulasi, bukan satu harga tunggal, jelaskan sebagai rentang kalau disebut; field fundamental yang null berarti datanya memang tidak tersedia, jangan ditulis seolah ada angkanya):
